...
**Status: step 0 DONE, 2026-07-28. The dump below is RUN (real recordings, not arithmetic off M11's
timing table) and it is the design's factual ground. EVERY decision in the table at the bottom is
PINNED AS SEEDED (user, 2026-07-28) — including the two the dump answered: no engine step, no new
corpus program. Steps 1–5 are the authoring, the wiring and the browser pass; nothing is authored
yet.**
