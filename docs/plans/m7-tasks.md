...
**Status: steps 0–2a COMPLETE, step 2b (pairing) next. 2026-07-20 (1684 tests).** Shipped and PROVEN
...
pinned for all three existing models (step 1), and the width-1 superscalar base, which reproduces M3’s closed form EXACTLY over the whole corpus × config matrix (step 2a). **Nothing is browser-verified yet, because nothing
